...
const NetworkBar = () => {
  const links = [
    ...
    { name: "Hell Yeah Games", url: import.meta.env.VITE_HELL_YEAH_URL || "https://hellyeah-games-inc.com" },
    ...
    { name: "Gamer Gurls", url: import.meta.env.VITE_GAMER_GURLS_URL || "https://gamer-gurls.com" },
